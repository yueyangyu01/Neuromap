...
class SignUpForm(UserCreationForm):
    ...
    dob = forms.CharField(label="", max_length=100, widget=forms.TextInput(attrs={'class':'form-control', 'placeholder':'Date of Birth'}))
...
class AddRecordForm(forms.ModelForm):
    ...
    dob =  forms.CharField(required=True, widget=forms.widgets.TextInput(attrs={"placeholder":"Date of Birth", "class":"form-control"}), label="")
    class Meta:
        model = Record
        exclude = ("user",)